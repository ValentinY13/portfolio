               ...
               <ul class="space-y-6">
                ...
                <li class="flex gap-4">
                  ...
                  <div>
                    ...
                    <p class="text-grey-100 text-sm">Version PDF complète disponible <a href="/CV_Valentin_Yerna.pdf" target="_blank" rel="noopener noreferrer" class="underline underline-offset-2 text-accent decoration-accent hover:text-white-100 transition-colors">ici</a>.</p>
                  </div>
                </li>
               </ul>
             </div>
